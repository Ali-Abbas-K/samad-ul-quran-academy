...
/**
 * Only orphan WAL/SHM files are removed, and only when the main database file is
 * missing. An existing database is NEVER deleted or recreated by this module —
 * all schema changes below are additive.
 */
